...
/***/ function(module, exports, __webpack_require__) {
	...
	var polls = __webpack_require__(12);
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://serene-temple-92248.herokuapp.com',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onMenu = function onMenu(event) {
	  event.preventDefault();
	  api.index().then(ui.indexSuccess).catch(ui.failure);
	};

	var onGetPolls = function onGetPolls(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (data.poll.id.length === 0) {
	    ui.failure();
	  } else {
	    api.show(data.poll.id).then(ui.showSuccess).catch(ui.failure);
	  }
	};

	var onCreatePolls = function onCreatePolls(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  $('#message-user').text('Success! Poll #' + data.poll.id + ' created.');
	  api.create(data).then(ui.showSuccess).catch(ui.failure);
	};

	var onUpdatePolls = function onUpdatePolls(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.update(data.poll.id, data).then(ui.updateSuccess).catch(ui.failure);
	};

	var onDestroyPolls = function onDestroyPolls(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.destroy(data.poll.id).then(ui.destroySuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showPollsTemplate = __webpack_require__(15);
	var showPollTemplate = __webpack_require__(35);

	var indexSuccess = function indexSuccess(data) {
	  var showPollsHtml = showPollsTemplate({
	    polls: data.polls
	  });
	  $('.content').show();
	...
	var showSuccess = function showSuccess(data) {
	  var showPollHtml = showPollTemplate({
	    poll: data.poll
	  });
	  $('.content').show();
	...
	var createSuccess = function createSuccess(data) {
	  var showPollHtml = showPollsTemplate({
	    polls: data.polls
	  });
	  $('.content').show();
	  $('.content').empty().append(showPollHtml);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div data-id=\""
	    ...
	    + "</p>\n    <p class=\"options\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.option1 : stack1), depth0))
	    + "</p>\n      <p> OR </p>\n      <p class=\"option2\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.option2 : stack1), depth0))
	    + "</p>\n      <p> _____________________</p>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.polls : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div data-id=\""
	    ...
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.poll : depth0)) != null ? stack1.id : stack1), depth0))
	    + "</h3>\n  <h3 class=\"title\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.poll : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</h3>\n  <p class=\"body\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.poll : depth0)) != null ? stack1.body : stack1), depth0))
	    + "</p>\n  <p class=\"options\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.poll : depth0)) != null ? stack1.option1 : stack1), depth0))
	    + "</p>\n    <p> OR </p>\n    <p class=\"option2\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.poll : depth0)) != null ? stack1.option2 : stack1), depth0))
	    + "</p>\n\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Amatic+SC:400,300,700);", ""]);
